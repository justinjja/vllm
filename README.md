...
| --- | --- | --- |
| 2026-09-18 | Tested a more balanced PP8 partition for full-context prefill. | Fresh retrieval from 1,046,659 input tokens passed in 697.38 s to first token, versus 892.51 s with the prior partition. Short quality checks passed, but cached generation failed with a CUDA launch error. This candidate is **not qualified**; the validated recipes remain preferred. [Trial record](docs/cmp170hx/glm53.md#balanced-partition-trial). |
